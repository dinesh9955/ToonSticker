...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(getString(R.string.app_name_detail));
...
//                    shareMessage = shareMessage + "https://play.google.com/store/apps/details?id=com.romantic.couple.love.stickers.wastickerapps" + "\n\n";
...
//                Uri uri = Uri.parse("market://details?id=com.romantic.couple.love.stickers.wastickerapps");
...
//                            Uri.parse("http://play.google.com/store/apps/details?id=com.romantic.couple.love.stickers.wastickerapps")));
                }
                return true;
            default:
                return super.onOptionsItemSelected(item);
